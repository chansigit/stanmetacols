...
SYSTEM_PROMPT = (
    ...
    "both, one, or neither.\n\n"
    "For the organ and tissue roles: organ is the solid anatomical organ a cell "
    "came from (e.g. heart, liver, kidney, lung, brain); tissue is the sampled "
    "biological material or anatomical site (e.g. blood, PBMC, bone marrow, "
    "lymph node, tumor, biopsy, CSF). They are distinct — judge by the column's "
    "values and name. A dataset may have organ, tissue, both, or neither.\n\n"
