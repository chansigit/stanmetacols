...
flowchart TD
    ...
    J --> K["CLI: text / JSON<br/>exit 0 found · 2 none · 1 IO error"]
```
...
`RankResult.top()` returns the single best candidate — **but the tool ranks; you
decide whether to trust the pick.**
